...
% L*L: size of the supercell eg.L=20, 20x20 supercell
% conc_Mn: concentration of Mangnese dopants in the lattice
% repeat: (an integer); each time this code will assume a different initial distributions of Mn-dopant in the lattice and will calculate average and std for Tc.
clc
close all
